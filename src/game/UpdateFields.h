...
enum EUnitFields
{
   ...
   INFINITY_AP_MELEE_1                        = 0x007B, // TYPE: INT
   ...
   INFINITY_PARRYRATING                       = 0x04D2, // TYPE: INT
   INFINITY_RESILIENCE                        = 0x04DE, // TYPE: INT
   ...
   INFINITY_MELEE_MAINMAXDMG                  = 0x0047, // TYPE: FLOAT
   INFINITY_MELEE_OFFMINDMG                   = 0x0046, // TYPE: FLOAT
   INFINITY_MELEE_OFFMAXDMG                   = 0x0047, // TYPE: FLOAT
   INFINITY_MELLE_OFFTIME                     = 0x003E, // TYPE: FLOAT
   INFINITY_MELLE_MAINTIME                    = 0x003E, // TYPE: FLOAT

   INFINITY_RANGED_CRITRATING                 = 0x04D8, // TYPE: INT
   INFINITY_RANGED_HASTERATING                = 0x04E1, // TYPE: INT
   INFINITY_RANGED_HITRATING                  = 0x04D5, // TYPE: INT
   ...
   INFINITY_SPELL_BONUSDMG                    = 0x0496, // TYPE: INT
   INFINITY_SPELL_BONUSHEAL                   = 0x04A8, // TYPE: INT
   INFINITY_SPELL_CRITPROC                    = 0x040B, // TYPE: FLOAT	
};
