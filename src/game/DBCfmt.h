...
const char HolidayNamesfmt[]="nssssssssssssssssi";
const char HolidayDescriptionsfmt[]="nssssssssssssssssi";
const char Holidaysfmt[]="niiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiisiii";
