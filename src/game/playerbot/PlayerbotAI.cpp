...
//		m_targetProtect = 0;
    ...
    else
    {
        ...
        {
            std::string msg = "What? follow, stay, (c)ast <spellname>, spells, (e)quip <itemlink>, (u)se <itemlink>, drop <questlink>, report, quests, stats, collect, talent, (READ THE README.PLAYERBOT FOR MORE COMMANDS)";
            SendWhisper(msg, fromPlayer);
            m_bot->HandleEmoteCommand(EMOTE_ONESHOT_TALK);
        }
    }
