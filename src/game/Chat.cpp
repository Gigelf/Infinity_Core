...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "hq",	            SEC_PLAYER,         false, &ChatHandler::HandleHQCommand,                  "", NULL },
	{ "qg",	            SEC_PLAYER,         false, &ChatHandler::HandleHQCommand,                  "", NULL },
        { "Addhq",	    SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleAddHQCommand,               "", NULL },
	{ "Delhq",	    SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleDelHQCommand,               "", NULL },
	{ "tp",		    SEC_PLAYER,		false, &ChatHandler::HandleTpCommand,		       "", NULL },
        { "lookuptp",       SEC_PLAYER,    	true,  &ChatHandler::HandleLookupTpCommand,            "", NULL },
        { "addatp",	    SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleAddATpCommand,              "", NULL },
        { "addhtp",	    SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleAddHTpCommand,              "", NULL },
        { "deltp",          SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleDelTpCommand,               "", NULL },
